...
//public $academic_level_id;
	...
	public function rules()
	{
		...
		return array(
			...
			array('academic_level_id, institution_id, attribute_1, attribute_2', 'length', 'max'=>255),
			array('note', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, profile_id, academic_level_id, institution_id, attribute_1, attribute_2, start_year, graduate_year, grade, note', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'academic_level_id' => Yii::t('strings', 'Academic Level'),
			'institution_id' => Yii::t('strings', 'Institution'),
			'attribute_1' => Yii::t('strings', 'Major'),
			'attribute_2' => Yii::t('strings', 'Attribute 2'),
			'start_year' => Yii::t('strings', 'Start Year'),
			'graduate_year' => Yii::t('strings', 'Graduate Year'),
			'grade' => Yii::t('strings', 'Grade'),
	...
	{
		return $_POST['Education']['institution_name'];
	}
