...
class WorkhistoryController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['Workhistory'];
			$model->profile_id = Profile::model()->getProfileid(Yii::app()->user->id);
			
			$model->start_date = str_replace('/', '-', $model->start_date);
			$model->finish_date = str_replace('/', '-', $model->finish_date);
	...
	{
	/*
		$dataProvider=new CActiveDataProvider('Workhistory');
	...
	{
		$model=new Workhistory('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['Workhistory']))
			$model->attributes=$_GET['Workhistory'];
	...
	{
		$model=Workhistory::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Workhistory $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='workhistory-form')
		{
