...
//echo '<br/>score array size = ' . sizeof($score_array);
//echo '<br/>json array size = ' . sizeof($json_array);
//echo '<br/><br/>';
...
$subtest_key = key($subsets[$subset_index]);
	...
	$max_values = array(23,41,23,32,14,23,41,23);
		...
		$value = $score;
				...
				//echo $key . ' => ' . $value . '<br/>';
					//echo $counter+1 . '. ' . $key.' SCORE : '. $score .'   RESPONSE : '. base64_decode($response_value);;
				...
				if ($subset_item_counter + 1 < $subsets[$subset_index][$subtest_key])
				{
					...
					//echo '=== '.$subtest_key.' <br/>=== TRUE : '.$truefalse_array[$subtest_key]["true"]. ' <br/>=== FALSE : '.$truefalse_array[$subtest_key]["false"]. ' <br/>=== UNANSWERED : '.$truefalse_array[$subtest_key]["unanswered"].'=== PERSEN DIJAWAB : '. $answered_count_array[$subset_index] / ($true_count + $false_count + $unanswered_count).'<br/><br/>';
...
$key = key($item);
	...
	echo $key . ' => ' . $value . '<br/>';
				...
				if ($subset_item_counter + 1 < $subsets[$subset_index][$subtest_key])
				{
					...
					echo '=== '.$subtest_key.' === TRUE : '.$truefalse_array[$subtest_key]["true"].'=== PERSEN DIJAWAB : '. $answered_count_array[$subset_index] / ($true_count + $false_count + $unanswered_count).'<br/><br/>';
					$answered_count = $answered_count + $true_count + $false_count + $unanswered_count;
					$true_count = 0;
					$false_count = 0;
					$unanswered_count = 0;
...
//$score_array['kemampuan_dasar_keteknikan'] = $con->scale('20to7',$con->scale('11_e',$truefalse_array['subtest 11']['true']));
...
<table border=0 cellpadding=0 cellspacing=0 width=703 class=xl6521287
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=27 rowspan=2 class=xl17321287 width=703 style='border-right: 2.0pt double black; width: 378pt; font-size: 9pt;'>Kecerdasan umum Sdr/i, <?php echo $nama;?> <span
...
">
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=10 class=xl8421287 style='height:10.0pt'>l</td>
  <td colspan=27 rowspan=2 class=xl9321287 width=703 style='border-right: 2.0pt double black; width: 378pt; font-size: 9pt;'>Secara spesifik Sdr/i, <?php echo $nama;?> <span
